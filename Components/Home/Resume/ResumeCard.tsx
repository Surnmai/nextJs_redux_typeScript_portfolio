          ...
          <div className="flex items-start space-x-6 bg-blue-950/20 transition-all duration-300 p-4 sm:p-8 rounded-md">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-300 text-sm sm:text-base pt-3">
                ...
                fugiat iste laboriosam expedita delectus, odit cupiditate
                deserunt adipisci sequi, impedit obcaecati ullam? Doloremque
                maiores sapiente dolore impedit dolores, tempore adipisci!
              </p>
            </div>
          </div>
        </div>
